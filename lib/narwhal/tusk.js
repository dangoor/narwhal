...
parser.command('sea', commandsPath + '/sea/parser');
parser.command('package', commandsPath + '/package/parser');
parser.command('config', commandsPath + '/config/parser');
parser.command('catalog', commandsPath + '/catalog/parser');
