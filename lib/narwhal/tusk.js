...
parser.command('create-package', commandsPath + '/package/create');
parser.command('install-package', commandsPath + '/package/install');
...
parser.command('switch-sea', commandsPath + '/sea/switch');
