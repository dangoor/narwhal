...
var Catalog = exports.Catalog = function (uri, options) {
    ...
    if(util.has(options, "isSeaCatalog")) {
        this.isSeaCatalog = options.isSeaCatalog;
    }
}
...
Catalog.prototype.getPackage = function(name) {
    ...
    var uri = URI.parse(catalog.packages[name].origin.url);
...
exports.getNarwhalCatalog = function() {
    return Catalog(exports.getNarwhalCatalogPath());
}
...
exports.getSeaCatalogPath = function() {
    return SEA.getCatalogPath();
}
exports.getSeaCatalog = function() {
    return SEA.getCatalog();
}
