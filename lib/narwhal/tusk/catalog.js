...
// needed
Catalog.prototype.addPackage = function(locator) {
    
    if(this.hasPackage(locator.getPackageName())) {
    ...
    catalog.packages[locator.getPackageName()] = [
        [locator.getRevision(), locator.getInfo()]
    ];
