...
Sea.prototype.validate = function() {
    ...
    if(!(this.path.join("narwhal.conf").exists() || this.path.join("narwhal.js").exists()) ||
...
Sea.prototype.getCatalog = function() {
    return CATALOG.Catalog(this.path.join("catalog.json"), {
        isSeaCatalog: true
    });
}
...
exports.getCatalogPath = function() {
    return tusk.getDirectory().join("catalog.json");
}

exports.getCatalog = function() {
    return CATALOG.Catalog(exports.getCatalogPath(), {
        isSeaCatalog: true
    });
}
...
exports.getActive = function() {
    ...
    if(path) {
        ...
        var sea = exports.Sea(tusk.getDirectory());
        if(sea.validate()) {
            return sea;
        }
    }
