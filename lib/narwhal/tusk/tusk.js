...
exports.getSeaCatalog = function() {
    return catalog.Catalog(exports.getTuskDirectory().join("catalog.json"));
}

exports.getPlanetCatalog = function(name) {
    return catalog.Catalog(exports.getPlanetTuskDirectory().join(name + ".catalog.json"));
}
...
exports.getConfigs = function() {
  return [
    exports.getSeaConfig(),
    exports.getPlanetConfig()
  ];
}
